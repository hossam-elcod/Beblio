...
const FolderComponent = () => {
  ...
  if (isLoading) {
    return (
      <Row>
        <Col md="12">
          <h1 className="text-center my-5">Récupération de données...</h1>
        </Col>
      </Row>
    );
  }
  ...
  if (
    ...
    return (
      <>
        ...
        <Row>
          <Col md="12">
            <p className="text-center small text-center my-5">Dossier vide</p>
          </Col>
        </Row>
      </>
    );
  ...
  return (
    <>
      ...
      {userFolders && userFolders.length > 0 && (
        <>
          <p className="text-center border-bottom py-2">Dossiers créés</p>
          <Row
            md="2"
            style={{ height: "auto" }}
          ...
          >
            {!folders ? (
              <h1 className="text-center">Récupération de fichiers....</h1>
            ) : (
      ...
      {createdFiles && createdFiles.length > 0 && (
        <>
          <p className="text-center border-bottom py-2">Fichiers créés</p>
          <Row
            md="2"
            style={{ height: "auto" }}
            className="pt-2  gap-2 pb-4 px-5"
      ...
      {uploadedFiles && uploadedFiles.length > 0 && (
        <>
          <p className="text-center border-bottom py-2">Fichiers téléchargés</p>
          <Row
            md="2"
            style={{ height: "auto" }}
            className="pt-2  gap-2 pb-4 px-5"
